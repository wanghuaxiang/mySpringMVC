package com.wanghuaxiang.mvc.framework.servlet;
...
import com.wanghuaxiang.mvc.framework.context.MyApplicationContext;
...
public class MyDispatcherServlet extends HttpServlet {
	...
	private class HandlerAdapter {
		...
		public MyModelAndView handle(HttpServletRequest req, HttpServletResponse resp, Handler handler)
				throws Exception {
